...
public class AddEnvActionTest extends ActionTest {
    ...
    public void ActionPerformed_SelectedHasNotLocalPath_DoNothing() throws IOException {
        ...
        AnActionEvent anActionEvent = createAddEnvActionEvent();
        action.actionPerformed(anActionEvent);
        verify(kn, times(0)).addEnv(anyString());
    }

    @Test
    public void ActionPerformed_SelectedHasLocalPath_StartAddEnvWorkflow() throws IOException, InterruptedException {
        AnAction action = new AddEnvAction();
    ...
    private AnActionEvent createAddEnvActionEvent() {
