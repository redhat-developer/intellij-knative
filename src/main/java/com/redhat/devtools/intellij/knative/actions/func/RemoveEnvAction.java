...
public class RemoveEnvAction extends RemoveConfigAction {
    ...
    public String getSuccessMessage(String namespace, String name) throws IOException {
        return "Removed environment variable from function " + name + " in namespace " + namespace + ".";
    }

    @Override
    protected TelemetryMessageBuilder.ActionMessage createTelemetry() {
        return TelemetryService.instance().action(NAME_PREFIX_CRUD + "remove env variable");
    }
